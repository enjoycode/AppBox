...
export class CSharpLanguage implements CodeEditor.ICodeLanguage {
    ...
    private static readonly TokenMap: System.Dictionary<string, CodeEditor.TokenType> = new System.Dictionary().Init([
        ...
        ["as", CodeEditor.TokenType.Keyword],
        ["base", CodeEditor.TokenType.Keyword],
        ["break", CodeEditor.TokenType.Keyword],
        ["case", CodeEditor.TokenType.Keyword],
        ["catch", CodeEditor.TokenType.Keyword],
        ["checked", CodeEditor.TokenType.Keyword],
        ["class", CodeEditor.TokenType.Keyword],
        ["continue", CodeEditor.TokenType.Keyword],
        ["default", CodeEditor.TokenType.Keyword],
        ["delegate", CodeEditor.TokenType.Keyword],
        ["do", CodeEditor.TokenType.Keyword],
        ["else", CodeEditor.TokenType.Keyword],
        ["enum", CodeEditor.TokenType.Keyword],
        ["event", CodeEditor.TokenType.Keyword],
        ["explicit", CodeEditor.TokenType.Keyword],
        ["finally", CodeEditor.TokenType.Keyword],
        ["for", CodeEditor.TokenType.Keyword],
        ["foreach", CodeEditor.TokenType.Keyword],
        ["goto", CodeEditor.TokenType.Keyword],
        ["if", CodeEditor.TokenType.Keyword],
        ["implicit", CodeEditor.TokenType.Keyword],
        ["interface", CodeEditor.TokenType.Keyword],
        ["is", CodeEditor.TokenType.Keyword],
        ["lock", CodeEditor.TokenType.Keyword],
        ["namespace", CodeEditor.TokenType.Keyword],
        ["operator", CodeEditor.TokenType.Keyword],
        ["params", CodeEditor.TokenType.Keyword],
        ["return", CodeEditor.TokenType.Keyword],
        ["sizeof", CodeEditor.TokenType.Keyword],
        ["stackalloc", CodeEditor.TokenType.Keyword],
        ["struct", CodeEditor.TokenType.Keyword],
        ["switch", CodeEditor.TokenType.Keyword],
        ["throw", CodeEditor.TokenType.Keyword],
        ["try", CodeEditor.TokenType.Keyword],
        ["typeof", CodeEditor.TokenType.Keyword],
        ["unchecked", CodeEditor.TokenType.Keyword],
        ["using", CodeEditor.TokenType.Keyword],
        ["while", CodeEditor.TokenType.Keyword],
        ["new", CodeEditor.TokenType.Keyword],
        ["await", CodeEditor.TokenType.Keyword],
        ["in", CodeEditor.TokenType.Keyword],
        ["yield", CodeEditor.TokenType.Keyword],
        ["get", CodeEditor.TokenType.Keyword],
        ["set", CodeEditor.TokenType.Keyword],
        ["when", CodeEditor.TokenType.Keyword],
        ["out", CodeEditor.TokenType.Keyword],
        ["ref", CodeEditor.TokenType.Keyword],
        ["from", CodeEditor.TokenType.Keyword],
        ["where", CodeEditor.TokenType.Keyword],
        ["select", CodeEditor.TokenType.Keyword],
        ["record", CodeEditor.TokenType.Keyword],
        ["init", CodeEditor.TokenType.Keyword],
        ["with", CodeEditor.TokenType.Keyword],
        ["let", CodeEditor.TokenType.Keyword],
        ["var", CodeEditor.TokenType.Keyword],
        ["this", CodeEditor.TokenType.Keyword],
    ]);
    ...
    public GetTokenType(node: CodeEditor.TSSyntaxNode): CodeEditor.TokenType {
        ...
        if (!node.isNamed()) {
            let res: any;
            if (CSharpLanguage.TokenMap.TryGetValue(type, new System.Out(() => res, $v => res = $v)))
                return res;
            return CodeEditor.TokenType.Unknown;
        }
