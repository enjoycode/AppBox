...
export class CSharpLanguage implements CodeEditor.ICodeLanguage {
    ...
    public IsLeafNode(node: CodeEditor.SyntaxNode): boolean {
    ...
    public GetTokenType(node: CodeEditor.SyntaxNode): CodeEditor.TokenType {
    ...
    private GetIdentifierTokenType(node: CodeEditor.SyntaxNode): CodeEditor.TokenType {
    ...
    private GetMemberAccessTokenType(node: CodeEditor.SyntaxNode): CodeEditor.TokenType {
...
`;
    ...
    private _foldQuery: Nullable<CodeEditor.Query>;
