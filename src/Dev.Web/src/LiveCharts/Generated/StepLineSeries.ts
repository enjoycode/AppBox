...
export class StepLineSeries<TModel> extends LiveChartsCore.StepLineSeries<TModel, LiveCharts.CircleGeometry, LiveCharts.LabelGeometry, LiveCharts.SkiaDrawingContext, LiveCharts.StepLineAreaGeometry,
    LiveCharts.StepPoint<LiveCharts.CircleGeometry>> {
    public constructor() {
        super(() => new LiveCharts.CircleGeometry(), () => new LiveCharts.LabelGeometry(),
            () => new LiveCharts.StepLineAreaGeometry(),
            () => new LiveCharts.StepPoint<LiveCharts.CircleGeometry>(() => new LiveCharts.CircleGeometry()));
    }
}
