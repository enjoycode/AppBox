...
export class StackedRowSeries<TModel> extends LiveChartsCore.StackedRowSeries<TModel, LiveCharts.RoundedRectangleGeometry, LiveCharts.LabelGeometry, LiveCharts.SkiaDrawingContext> {
    public constructor() {
