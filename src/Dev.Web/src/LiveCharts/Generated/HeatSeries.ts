...
export class HeatSeries<TModel> extends LiveChartsCore.HeatSeries<TModel, LiveCharts.ColoredRectangleGeometry, LiveCharts.LabelGeometry, LiveCharts.SkiaDrawingContext> {
    public constructor() {
        super(() => new LiveCharts.ColoredRectangleGeometry(), () => new LiveCharts.LabelGeometry());
    }
}
