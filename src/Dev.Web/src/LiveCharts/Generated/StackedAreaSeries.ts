...
export class StackedAreaSeries<TModel> extends LiveChartsCore.StackedAreaSeries<TModel, LiveCharts.CircleGeometry, LiveCharts.LabelGeometry, LiveCharts.SkiaDrawingContext, LiveCharts.CubicBezierAreaGeometry,
    LiveCharts.BezierPoint<LiveCharts.CircleGeometry>> {
    public constructor() {
        super(() => new LiveCharts.CircleGeometry(), () => new LiveCharts.LabelGeometry(),
            () => new LiveCharts.CubicBezierAreaGeometry(), () => new LiveCharts.BezierPoint<LiveCharts.CircleGeometry>(new LiveCharts.CircleGeometry()));
    }
}
