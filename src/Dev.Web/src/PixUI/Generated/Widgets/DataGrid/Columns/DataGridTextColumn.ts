...
export class DataGridTextColumn<T> extends PixUI.DataGridColumn<T> {
    public constructor(label: string, cellValueGetter: System.Func<T, string>, width: Nullable<PixUI.ColumnWidth> = null, headerCellStyle: Nullable<PixUI.CellStyle> = null, cellStyle: Nullable<PixUI.CellStyle> = null, cellStyleGetter: Nullable<System.Func<T, number, PixUI.CellStyle>> = null, frozen: boolean = false) {
        super(label, width, headerCellStyle, cellStyle, cellStyleGetter, frozen);
        this._cellValueGetter = cellValueGetter;
    }

    private readonly _cellValueGetter: System.Func<T, string>;
