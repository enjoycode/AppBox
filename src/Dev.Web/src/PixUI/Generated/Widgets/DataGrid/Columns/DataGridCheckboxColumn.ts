...
export class DataGridCheckboxColumn<T> extends PixUI.DataGridHostColumn<T> {
    public constructor(label: string,
                       cellValueGetter: System.Func2<T, boolean>,
                       cellValueSetter: Nullable<System.Action2<T, boolean>> = null) {
        super(label, (data, _) => {
            let state = new PixUI.RxProperty<boolean>(() => cellValueGetter(data),
