...
var _Chart, _Series2, _Entity, _DataSource, _Visual, _Label, _HoverArea, _IsEmpty, _PrimaryValue, _SecondaryValue, _TertiaryValue, _QuaternaryValue, _QuinaryValue, _CurrentThemeId, _Context, _Stroke, _Fill, _Enumerator, _PointerLocation, _VisualElements, _SeriesProperties, _IsFirstDraw, _MeasureWork, _ThemeId, _IsLoaded, _IsFirstDraw2, _Canvas, _SeriesContext, _ControlSize, _DrawMarginLocation, _DrawMarginSize, _LegendPosition, _Legend, _TooltipPosition, _TooltipFindingStrategy, _Tooltip, _AnimationsSpeed, _EasingFunction, _VisualElements2, _PreviousLegendPosition, _PreviousSeriesAtLegend, _AngleAxes, _RadiusAxes, _Series3, _FitToBounds, _TotalAnge, _InnerRadius, _InitialRotation, _View, _Series4, _ValueBounds, _IndexBounds, _PushoutBounds, _XAxes, _YAxes, _Series5, _Sections, _IsZoomingOrPanning, _IsConfigured, _Default, _Function, _Speed, _Layers, _MapWidth, _MapHeight, _XOffset, _YOffset, _Chart2, _HeatPaint, _HeatStops, _Bounds, _CoreMap, _MapFile, _Projector, _View2, _Pivot, _Direction, _BoundsHypotenuse, _Coordinates, _ShortName, _Name, _HSize, _HCenter, _Lands, _PropertyName, _IsValid, _HasPreviousState, _HasPreviousState2, _Coordinate2, _Coordinate3, _Coordinate4, _Coordinate5, _Coordinate6, _Coordinate7, _Coordinate8, _Coordinate9, _MaxVal, _MinVal, _AreaGeometry, _Bounds2, _CenterX, _CenterY, _InnerRadius2, _MaxRadius, _MinRadius, _MinAngle, _MaxAngle, _IsEmpty2, _Max, _Min, _PaddingMax, _PaddingMin, _RequestedGeometrySize, _MinDelta, _IsEmpty3;
...
class ChartPointContext {
  constructor(chart, series, entity) {
    ...
    __privateAdd(this, _Series2, void 0);
...
const _Coordinate = class {
  constructor(primaryValue, secondaryValue, tertiaryValue, quaternaryValue, quinaryValue, isEmpty = false) {
    __privateAdd(this, _IsEmpty, false);
...
class VisualElementsEventArgs {
  constructor(visualElements, pointerLocation) {
    ...
    __privateAdd(this, _VisualElements, void 0);
...
const _LvcPointD = class {
  ...
  Clone() {
    return new _LvcPointD(this.X, this.Y);
  }
};
let LvcPointD = _LvcPointD;
__publicField(LvcPointD, "Empty", new _LvcPointD(0, 0).Clone());
...
class LineSegment extends Animatable {
  ...
  Follows(segment) {
    ...
    let xProp = segment.MotionProperties.GetAt("Xj");
    let yProp = segment.MotionProperties.GetAt("Yj");
...
const _Series = class extends ChartElement {
  ...
  set Pivot(value) {
    this.SetProperty(new System.Ref(() => this.pivot, ($v) => this.pivot = $v), value, "Pivot");
  }
  get Mapping() {
...
class FinancialSeries extends CartesianSeries {
    ...
    for (const point of this.Fetch(cartesianChart)) {
      ...
      if (this.DataLabelsPaint != null) {
        ...
        if (label == null) {
          ...
          Extensions.TransitionateProperties(l, "X", "Y").WithAnimationBuilder((animation) => animation.WithDuration(this.AnimationsSpeed ?? cartesianChart.AnimationsSpeed).WithEasingFunction(this.EasingFunction ?? cartesianChart.EasingFunction));
  ...
  SetDefaultPointTransitions(chartPoint) {
    ...
    Extensions.TransitionateProperties(visual, "X", "Width", "Y", "Open", "Close", "Low").WithAnimationBuilder((animation) => animation.WithDuration(this.AnimationsSpeed ?? chart.AnimationsSpeed).WithEasingFunction(this.EasingFunction ?? chart.EasingFunction)).CompleteCurrentTransitions();
  }
...
const _LineSeries = class extends StrokeAndFillCartesianSeries {
  ...
  set GeometrySize(value) {
    this.SetProperty(new System.Ref(() => this._geometrySize, ($v) => this._geometrySize = $v), value, "GeometrySize");
  }
  get LineSmoothness() {
  ...
  set LineSmoothness(value) {
    ...
    if (value < 0)
      v = 0;
    this.SetProperty(new System.Ref(() => this._lineSmoothness, ($v) => this._lineSmoothness = $v), v, "LineSmoothness");
  }
  ...
  Invalidate(chart) {
    ...
    for (const segment of segments) {
      ...
      if (this.Fill != null) {
        ...
        fillPath.Pivot = p;
        if (isNew) {
          Extensions.TransitionateProperties(fillPath, "Pivot").WithAnimationBuilder((animation) => animation.WithDuration(this.AnimationsSpeed ?? cartesianChart.AnimationsSpeed).WithEasingFunction(this.EasingFunction ?? cartesianChart.EasingFunction)).CompleteCurrentTransitions();
        }
      }
      if (this.Stroke != null) {
        ...
        strokePath.Pivot = p;
        if (isNew) {
          Extensions.TransitionateProperties(strokePath, "Pivot").WithAnimationBuilder((animation) => animation.WithDuration(this.AnimationsSpeed ?? cartesianChart.AnimationsSpeed).WithEasingFunction(this.EasingFunction ?? cartesianChart.EasingFunction)).CompleteCurrentTransitions();
        }
      }
  ...
  SetDefaultPointTransitions(chartPoint) {
    let chart = chartPoint.Context.Chart;
    let visual = chartPoint.Context.Visual;
    Extensions.TransitionateProperties(visual.Geometry, "X", "Y", "Width", "Height", "TranslateTransform").WithAnimationBuilder((animation) => animation.WithDuration(this.AnimationsSpeed ?? chart.AnimationsSpeed).WithEasingFunction(this.EasingFunction ?? chart.EasingFunction)).CompleteCurrentTransitions();
    Extensions.TransitionateProperties(visual.Bezier, "Xi", "Yi", "Xm", "Ym", "Xj", "Yj").WithAnimationBuilder((animation) => animation.WithDuration(this.AnimationsSpeed ?? chart.AnimationsSpeed).WithEasingFunction(this.EasingFunction ?? chart.EasingFunction)).CompleteCurrentTransitions();
  }
  SoftDeleteOrDisposePoint(point, primaryScale, secondaryScale) {
    let visual = point.Context.Visual;
    if (visual == null)
...
class StepLineSeries extends StrokeAndFillCartesianSeries {
  ...
  SetDefaultPointTransitions(chartPoint) {
    ...
    let visual = chartPoint.Context.Visual;
    Extensions.TransitionateProperties(visual.Geometry, "X", "Y", "Width", "Height", "TranslateTransform").WithAnimationBuilder((animation) => animation.WithDuration(this.AnimationsSpeed ?? chart.AnimationsSpeed).WithEasingFunction(this.EasingFunction ?? chart.EasingFunction)).CompleteCurrentTransitions();
    Extensions.TransitionateProperties(visual.StepSegment, "Xi", "Yi", "Xj", "Yj").WithAnimationBuilder((animation) => animation.WithDuration(this.AnimationsSpeed ?? chart.AnimationsSpeed).WithEasingFunction(this.EasingFunction ?? chart.EasingFunction)).CompleteCurrentTransitions();
  }
  SoftDeleteOrDisposePoint(point, primaryScale, secondaryScale) {
    let visual = point.Context.Visual;
    if (visual == null)
...
class ScatterSeries extends StrokeAndFillCartesianSeries {
  ...
  SetDefaultPointTransitions(chartPoint) {
    ...
    Extensions.TransitionateProperties(visual, "X", "Y", "Width", "Height").WithAnimationBuilder((animation) => animation.WithDuration(this.AnimationsSpeed ?? chart.AnimationsSpeed).WithEasingFunction(this.EasingFunction ?? chart.EasingFunction)).CompleteCurrentTransitions();
  }
  SoftDeleteOrDisposePoint(point, primaryScale, secondaryScale) {
    let visual = point.Context.Visual;
    if (visual == null)
...
class HeatSeries extends CartesianSeries {
  ...
  SetDefaultPointTransitions(chartPoint) {
    let chart = chartPoint.Context.Chart;
    let visual = chartPoint.Context.Visual;
    Extensions.TransitionateProperties(visual, "X", "Width", "Y", "Height", "Color").WithAnimationBuilder((animation) => animation.WithDuration(this.AnimationsSpeed ?? chart.AnimationsSpeed).WithEasingFunction(this.EasingFunction ?? chart.EasingFunction)).CompleteCurrentTransitions();
  }
  SoftDeleteOrDisposePoint(point, primaryScale, secondaryScale) {
    let visual = point.Context.Visual;
    if (visual == null)
...
class RowSeries extends BarSeries {
  ...
  SetDefaultPointTransitions(chartPoint) {
    let chart = chartPoint.Context.Chart;
    let visual = chartPoint.Context.Visual;
    Extensions.TransitionateProperties(visual, "X", "Width", "Y", "Height").WithAnimationBuilder((animation) => animation.WithDuration(this.AnimationsSpeed ?? chart.AnimationsSpeed).WithEasingFunction(this.EasingFunction ?? chart.EasingFunction)).CompleteCurrentTransitions();
  }
  SoftDeleteOrDisposePoint(point, primaryScale, secondaryScale) {
    let visual = point.Context.Visual;
    if (visual == null)
...
class PolarLineSeries extends ChartSeries {
      ...
      for (const data of this.GetSpline(segment, scaler, stacker)) {
        ...
        if (this.DataLabelsPaint != null) {
          ...
          if (label == null) {
            ...
            Extensions.TransitionateProperties(l, "X", "Y").WithAnimationBuilder((animation) => animation.WithDuration(this.AnimationsSpeed ?? polarChart.AnimationsSpeed).WithEasingFunction(this.EasingFunction ?? polarChart.EasingFunction));
            l.CompleteTransition(null);
            label = l;
            data.TargetPoint.Context.Label = l;
          }
  ...
  SetDefaultPointTransitions(chartPoint) {
    let chart = chartPoint.Context.Chart;
    let visual = chartPoint.Context.Visual;
    Extensions.TransitionateProperties(visual.Geometry, "X", "Y", "Width", "Height").WithAnimationBuilder((animation) => animation.WithDuration(this.AnimationsSpeed ?? chart.AnimationsSpeed).WithEasingFunction(this.EasingFunction ?? chart.EasingFunction)).CompleteCurrentTransitions();
    Extensions.TransitionateProperties(visual.Bezier, "Xi", "Yi", "Xm", "Ym", "Xj", "Yj").WithAnimationBuilder((animation) => animation.WithDuration(this.AnimationsSpeed ?? chart.AnimationsSpeed).WithEasingFunction(this.EasingFunction ?? chart.EasingFunction)).CompleteCurrentTransitions();
  }
...
const _PieSeries = class extends ChartSeries {
    ...
    for (const point of fetched) {
      ...
      if (this.DataLabelsPaint != null && point.PrimaryValue >= 0) {
        ...
        if (label == null) {
          ...
          l.Y = cy;
          l.RotateTransform = actualRotation;
          Extensions.TransitionateProperties(l, "X", "Y").WithAnimationBuilder((animation) => animation.WithDuration(this.AnimationsSpeed ?? pieChart.AnimationsSpeed).WithEasingFunction(this.EasingFunction ?? pieChart.EasingFunction));
          l.CompleteTransition(null);
          label = l;
          point.Context.Label = l;
        }
  ...
  SetDefaultPointTransitions(chartPoint) {
    ...
    let chart = chartPoint.Context.Chart;
    let visual = chartPoint.Context.Visual;
    Extensions.TransitionateProperties(visual, "StartAngle", "SweepAngle", "PushOut").WithAnimationBuilder((animation) => animation.WithDuration(this.AnimationsSpeed ?? chart.AnimationsSpeed).WithEasingFunction(this.EasingFunction ?? chart.EasingFunction)).CompleteCurrentTransitions();
    if ((this.SeriesProperties & SeriesProperties.Gauge) == 0)
      Extensions.TransitionateProperties(visual, "CenterX", "CenterY", "X", "Y", "InnerRadius", "Width", "Height").WithAnimationBuilder((animation) => animation.WithDuration(this.AnimationsSpeed ?? chart.AnimationsSpeed).WithEasingFunction(this.EasingFunction ?? chart.EasingFunction)).CompleteCurrentTransitions();
  }
  SoftDeleteOrDisposePoint(point, primaryScale, secondaryScale) {
    let visual = point.Context.Visual;
    if (visual == null)
...
class Chart {
  constructor(canvas, defaultPlatformConfig, view) {
    ...
    __privateAdd(this, _VisualElements2, []);
  ...
  Invalidate(chart) {
    ...
    if (this.Fill != null) {
      ...
      if (this._fillSizedGeometry == null) {
        ...
        Extensions.TransitionateProperties(this._fillSizedGeometry, "X", "Width", "Y", "Height").WithAnimationBuilder((animation) => animation.WithDuration(chart.AnimationsSpeed).WithEasingFunction(chart.EasingFunction));
    ...
    if (this.Stroke != null) {
      ...
      if (this._strokeSizedGeometry == null) {
        ...
        Extensions.TransitionateProperties(this._strokeSizedGeometry, "X", "Width", "Y", "Height").WithAnimationBuilder((animation) => animation.WithDuration(chart.AnimationsSpeed).WithEasingFunction(chart.EasingFunction));
...
class PolarAxis extends ChartElement {
  ...
  Invalidate(chart) {
    ...
    if (!this._animatableBounds.HasPreviousState) {
      Extensions.TransitionateProperties(this._animatableBounds, "MinLimit", "MaxLimit").WithAnimationBuilder((animation) => animation.WithDuration(this.AnimationsSpeed ?? polarChart.AnimationsSpeed).WithEasingFunction(this.EasingFunction ?? polarChart.EasingFunction));
    ...
    for (let i = start; i <= max; i += s) {
      ...
      if (!separators.TryGetValue(i, new System.Out(() => visualSeparator, ($v) => visualSeparator = $v))) {
        ...
        if (this.LabelsPaint != null) {
          ...
          Extensions.TransitionateProperties(textGeometry, "X", "Y", "RotateTransform", "Opacity").WithAnimationBuilder((animation) => animation.WithDuration(this.AnimationsSpeed ?? polarChart.AnimationsSpeed).WithEasingFunction(this.EasingFunction ?? polarChart.EasingFunction));
          textGeometry.X = l.X;
          textGeometry.Y = l.Y;
        ...
        if (this.SeparatorsPaint != null && this.ShowSeparatorLines) {
          if (visualSeparator instanceof AxisVisualSeprator) {
            ...
            Extensions.TransitionateProperties(lineGeometry, "X", "X1", "Y", "Y1", "Opacity").WithAnimationBuilder((animation) => animation.WithDuration(this.AnimationsSpeed ?? polarChart.AnimationsSpeed).WithEasingFunction(this.EasingFunction ?? polarChart.EasingFunction));
          ...
          if (visualSeparator instanceof RadialAxisVisualSeparator) {
            ...
            Extensions.TransitionateProperties(circleGeometry, "X", "Y", "Width", "Height", "Opacity").WithAnimationBuilder((animation) => animation.WithDuration(this.AnimationsSpeed ?? polarChart.AnimationsSpeed).WithEasingFunction(this.EasingFunction ?? polarChart.EasingFunction));
...
const _Axis = class extends ChartElement {
  ...
  InvalidateCrosshair(chart, pointerPosition) {
    ...
    if (this._orientation == AxisOrientation.X) {
      ...
      if (this.CrosshairSnapEnabled) {
        ...
        let closestPoint = _Axis.FindClosestPoint(pointerPosition.Clone(), cartesianChart, cartesianChart.Series.Where((s) => s.ScalesXAt == axisIndex));
      ...
      if (this.CrosshairSnapEnabled) {
        ...
        let closestPoint = _Axis.FindClosestPoint(pointerPosition.Clone(), cartesianChart, cartesianChart.Series.Where((s) => s.ScalesYAt == axisIndex));
  ...
  DrawName(cartesianChart, size, lxi, lxj, lyi, lyj) {
    ...
    if (this._nameGeometry == null) {
      ...
      Extensions.TransitionateProperties(this._nameGeometry, "X", "Y").WithAnimationBuilder((animation) => animation.WithDuration(this.AnimationsSpeed ?? cartesianChart.AnimationsSpeed).WithEasingFunction(this.EasingFunction ?? cartesianChart.EasingFunction));
      isNew = true;
    }
  ...
  InitializeLine(lineGeometry, cartesianChart) {
    Extensions.TransitionateProperties(lineGeometry, "X", "X1", "Y", "Y1", "Opacity").WithAnimationBuilder((animation) => animation.WithDuration(this.AnimationsSpeed ?? cartesianChart.AnimationsSpeed).WithEasingFunction(this.EasingFunction ?? cartesianChart.EasingFunction));
  }
  InitializeTick(visualSeparator, cartesianChart, subTickGeometry = null) {
    ...
    Extensions.TransitionateProperties(tickGeometry, "X", "X1", "Y", "Y1", "Opacity").WithAnimationBuilder((animation) => animation.WithDuration(this.AnimationsSpeed ?? cartesianChart.AnimationsSpeed).WithEasingFunction(this.EasingFunction ?? cartesianChart.EasingFunction));
  }
  ...
  IntializeLabel(visualSeparator, cartesianChart, size, hasRotation, r) {
    ...
    if (hasRotation)
      textGeometry.RotateTransform = r;
    Extensions.TransitionateProperties(textGeometry, "X", "Y", "Opacity").WithAnimationBuilder((animation) => animation.WithDuration(this.AnimationsSpeed ?? cartesianChart.AnimationsSpeed).WithEasingFunction(this.EasingFunction ?? cartesianChart.EasingFunction));
  }
...
let Axis = _Axis;
__publicField(Axis, "$meta_LiveChartsCore_ICartesianAxis", true);
...
const _CartesianChart = class extends Chart {
  ...
  Zoom(pivot, direction, scaleFactor = null, isActive = false) {
    ...
    if (scaleFactor != null && direction != ZoomDirection.DefinedByScaleFactor)
      throw new System.InvalidOperationException(`When the scale factor is defined, the zoom direction must be ${"DefinedByScaleFactor"}... it just makes sense.`);
...
class DrawMarginFrame2 extends DrawMarginFrame {
  ...
  Invalidate(chart) {
    ...
    if (!this._isInitialized) {
      if (this._fillSizedGeometry != null) {
        Extensions.TransitionateProperties(this._fillSizedGeometry, "X", "Y", "Width", "Height").WithAnimationBuilder((animation) => animation.WithDuration(chart.AnimationsSpeed).WithEasingFunction(chart.EasingFunction)).CompleteCurrentTransitions();
      }
      if (this._strokeSizedGeometry != null) {
        Extensions.TransitionateProperties(this._strokeSizedGeometry, "X", "Y", "Width", "Height").WithAnimationBuilder((animation) => animation.WithDuration(chart.AnimationsSpeed).WithEasingFunction(chart.EasingFunction)).CompleteCurrentTransitions();
      }
...
class Bounds {
  constructor() {
    __privateAdd(this, _IsEmpty2, true);
...
class VisualElement extends ChartElement {
  ...
  GetPositionRelativeToParent() {
    ...
    if (this._parent != null) {
      let xProperty = this._parent.MotionProperties.GetAt("X");
      let yProperty = this._parent.MotionProperties.GetAt("Y");
