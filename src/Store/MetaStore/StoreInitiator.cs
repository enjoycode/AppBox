...
{
    internal static System.Threading.Tasks.Task InitAsync(System.Data.Common.DbTransaction txn)
    {
...
//         admin.SetBytes(Consts.EMPLOEE_PASSWORD_ID,
//             Runtime.RuntimeContext.PasswordHasher.HashPassword("760wb"));
...
//         test.SetBytes(Consts.EMPLOEE_PASSWORD_ID,
//             Runtime.RuntimeContext.PasswordHasher.HashPassword("la581"));
...
// #endif
//         entou.SetString(Consts.ORGUNIT_NAME_ID,
//             defaultEnterprise.GetString(Consts.ENTERPRISE_NAME_ID));
...
// #else
//         var emploee = new EntityModel(Consts.SYS_EMPLOEE_MODEL_ID, Consts.EMPLOEE,
...
//         //add pk
//         emploee.SqlStoreOptions.SetPrimaryKeys(emploee,
//             new List<FieldWithOrder> { new FieldWithOrder { MemberId = id.MemberId } });
// #endif
//         //Add members
...
//
//         var orgunits = new EntitySetModel(emploee, "OrgUnits", Consts.SYS_ORGUNIT_MODEL_ID,
//             Consts.ORGUNIT_BASE_ID);
...
// #else
//         var model = new EntityModel(Consts.SYS_ENTERPRISE_MODEL_ID, Consts.ENTERPRISE,
//             new SqlStoreOptions(SqlStore.DefaultSqlStoreId));
//         var id = new DataFieldModel(model, "Id", EntityFieldType.Guid);
//         model.AddSysMember(id, PK_Member_Id);
//         //add pk
//         model.SqlStoreOptions.SetPrimaryKeys(model,
//             new List<FieldWithOrder> { new FieldWithOrder { MemberId = id.MemberId } });
// #endif
//
...
// #else
//         var model = new EntityModel(Consts.SYS_WORKGROUP_MODEL_ID, Consts.WORKGROUP,
//             new SqlStoreOptions(SqlStore.DefaultSqlStoreId));
//         var id = new DataFieldModel(model, "Id", EntityFieldType.Guid);
//         model.AddSysMember(id, PK_Member_Id);
//         //add pk
...
//         var model = new EntityModel(Consts.SYS_ORGUNIT_MODEL_ID, Consts.ORGUNIT,
//             new SqlStoreOptions(SqlStore.DefaultSqlStoreId));
//         var id = new DataFieldModel(model, "Id", EntityFieldType.Guid);
//         model.AddSysMember(id, PK_Member_Id);
//         //add pk
...
//             new List<ulong>()
//             {
//                 Consts.SYS_ENTERPRISE_MODEL_ID, Consts.SYS_WORKGROUP_MODEL_ID,
//                 Consts.SYS_EMPLOEE_MODEL_ID
//             },
...
//         var parent = new EntityRefModel(model, "Parent", Consts.SYS_ORGUNIT_MODEL_ID,
//             new ushort[] { parentId.MemberId });
//         parent.AllowNull = true;
//         model.AddSysMember(parent, Consts.ORGUNIT_PARENT_ID);
//
//         var childs =
//             new EntitySetModel(model, "Childs", Consts.SYS_ORGUNIT_MODEL_ID, parent.MemberId);
