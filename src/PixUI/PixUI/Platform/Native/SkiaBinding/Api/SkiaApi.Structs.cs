...
namespace PixUI
{
    ...
    public unsafe partial struct SKFontMetrics : IEquatable<SKFontMetrics>
    {
        ...
        public readonly bool Equals(SKFontMetrics obj) =>
            fFlags == obj.fFlags && fTop == obj.fTop && fAscent == obj.fAscent &&
            fDescent == obj.fDescent && fBottom == obj.fBottom && fLeading == obj.fLeading &&
            fAvgCharWidth == obj.fAvgCharWidth && fMaxCharWidth == obj.fMaxCharWidth &&
            fXMin == obj.fXMin && fXMax == obj.fXMax && fXHeight == obj.fXHeight &&
            fCapHeight == obj.fCapHeight && fUnderlineThickness == obj.fUnderlineThickness &&
            fUnderlinePosition == obj.fUnderlinePosition &&
            fStrikeoutThickness == obj.fStrikeoutThickness &&
            fStrikeoutPosition == obj.fStrikeoutPosition;
    ...
    // sk_matrix_t
    [StructLayout(LayoutKind.Sequential)]
    public unsafe partial struct Matrix3 : IEquatable<PixUI.Matrix3>
    {
        // public float scaleX
        ...
        public readonly bool Equals(PixUI.Matrix3 obj) =>
        ...
        public readonly override bool Equals(object obj) =>
            obj is PixUI.Matrix3 f && Equals(f);

        public static bool operator ==(PixUI.Matrix3 left, PixUI.Matrix3 right) =>
            left.Equals(right);
