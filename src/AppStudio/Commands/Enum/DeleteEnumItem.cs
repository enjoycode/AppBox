...
{
    internal static async ValueTask Execute(ModelNode node, EnumItem member)
    {
        ...
        //查找成员引用
        var refs = await ReferenceService.FindEnumItemReferencesAsync(DesignHub.Current, node, member.Name);
