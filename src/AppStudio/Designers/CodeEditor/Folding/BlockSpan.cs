    ...
    bool isDefaultCollapsed = false)
{
    ...
    public BlockSpan(
        string type, bool isCollapsible, TextSpan textSpan, string bannerText = Ellipses, bool autoCollapse = false,
        bool isDefaultCollapsed = false)
        : this(type, isCollapsible, textSpan, textSpan, subHeadings: default, bannerText, autoCollapse,
            isDefaultCollapsed) { }
        ...
        Optional<bool> isDefaultCollapsed = default)
    {
        ...
        return new BlockSpan(
            newType, newIsCollapsible, newTextSpan, newHintSpan, newPrimarySpans, newBannerText, newAutoCollapse,
